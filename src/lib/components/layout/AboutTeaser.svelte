...
<script lang="ts">
	...
	name: "George Eliadis",
	role: "Founder & CEO",
	image: "/generated/image-a-headshot-of-a-friendly-middle-aged-man.webp"
};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`“We sat side-by-side with dispatchers—Probook started on paper and whiteboards long before it became software.”`}
			/>
